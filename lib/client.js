...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			"cfg.lowBalance.desc": "余额低于阈值时弹窗提醒",
			...
			"cfg.sidebar.items.hint": "侧边栏独立配置，可以通过拖动来调整顺序",
		...
		const en = {
			...
			"cfg.lowBalance.desc": "Popup when the balance drops below the threshold",
			...
			"cfg.sidebar.items.hint": "The sidebar is configured independently — drag the rows to change their order.",
